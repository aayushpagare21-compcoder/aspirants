...
export async function findMatchingPYQs(url: string) {
  ...
  const questions = await findRelaventQuestions(content.join(" "));
...
async function findRelaventQuestions(text: string) {
